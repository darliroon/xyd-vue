...
<!--      <el-form-item label="sourceName" prop="">-->
<!--        <el-input type="text" placeholder="请输入账号" v-model="form.username" style="z-index: 200"/>-->
<!--      </el-form-item>-->
<!--      <el-form-item>-->
<!--        <el-button type="primary" v-on:click="onSubmit('loginForm')" v-loading.fullscreen.lock="fullscreenLoading" style="z-index: 300">Log In</el-button>-->
<!--      </el-form-item>-->
<!--    </el-form>-->
...
export default {
  ...
  methods: {
    onSubmit (formName) {
      ...
      this.$axios.get('http://192.168.89.16:8080/dmLogIn/' + this.form.username + '/' + this.form.password).then(res => {
        if (res['data'] === 1) {
          this.$message({
