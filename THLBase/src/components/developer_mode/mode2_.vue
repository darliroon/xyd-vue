<template>
  <div>
    ...
    <el-form ref="loginForm" :model="form" :rules="rules" label-width="80px" class="login-box">
      <h3 class="login-title">New Nav</h3>
...
export default {
  ...
  data () {
    return {
      form: {
        ...
        all_args: 'x1 int, y1 int, z1 int, x2 int, y2 int, z2 int'
      },
  ...
  methods: {
    onSubmit (formName) {
      ...
      this.form.all_args = 'x1 int, y1 int, z1 int, x2 int, y2 int, z2 int'
      ...
      this.$axios({
        url: 'http://127.0.0.1:5000/newNavTable',
        method: 'post',
        // 发送格式为json
